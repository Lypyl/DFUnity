Shader "Daggerfall/BillboardBatch/TransparentCutoutForceForward" {
	// Efficient transparent-cutout styled billboard batch.
	// NOTES:
	//  - Does not work with VertexLit path.
	//	- Adds "exclude_path:prepass" pragma to force on forward rendering.
	//	- This allows for shadows without self-shadow artifacts in deferred path.
	Properties {
